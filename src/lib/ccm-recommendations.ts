...
const seasonCcm: Record<string, CcmSet> = {
  ...
  '연중시기 여름': {
    children: '주님 나를 세우소서 (어린이찬송)',
    youth: '주 함께하시니 - 마커스워십 (CCM)',
    young_adult: '은혜 위에 은혜 (워십)',
    senior: '주를 앙망하는 자 (찬송가 427장)',
  },
  '연중시기 가을': {
    children: '감사해요 나눠요 (어린이CCM)',
    youth: '흘러넘치는 사랑 - 어노인팅 (CCM)',
    young_adult: '주의 선하심과 인자하심이 (워십)',
    senior: '이 세상의 모든 것 다 (찬송가 45장)',
  },
  '연중시기 늦가을': {
    children: '예수님 기다려요 (어린이찬송)',
    youth: '마라나타 - 어노인팅 (CCM)',
    young_adult: '주의 나라가 이 땅에 (워십)',
    senior: '신자들아 일어나 (찬송가 251장)',
  },
  '연말': {
    children: '한 해를 보내요 (어린이찬송)',
    youth: '여기까지 인도하신 - 제이어스 (CCM)',
    young_adult: '주님의 신실하심 (워십)',
...
const themeCcm: { keywords: string[]; ccm: CcmSet }[] = [
  ...
  {
    keywords: ['추수', '나눔', '화해', '정의', '긍휼'],
    ccm: {
      children: '사랑을 나누어요 (어린이CCM)',
      youth: '주님의 손과 발이 되어 - 예수전도단 (CCM)',
      young_adult: '아버지의 마음으로 (워십)',
      senior: '네 이웃을 내 몸같이 (찬송가 220장)',
    },
  },
  {
    keywords: ['종말', '심판', '재림', '하나님나라', '영원', '충성', '깨어있음'],
    ccm: {
      children: '예수님 다시 오세요 (어린이찬송)',
      youth: '마라나타 - 어노인팅 (CCM)',
      young_adult: '주의 나라가 이 땅에 (워십)',
      senior: '신자들아 일어나 (찬송가 251장)',
    },
  ...
  {
    keywords: ['돌아봄', '새출발', '약속', '신실하심'],
    ccm: {
      children: '새해에도 예수님과 (어린이찬송)',
      youth: '여기까지 인도하신 - 제이어스 (CCM)',
      young_adult: '주님의 신실하심 (워십)',
      senior: '지금까지 지내온 것 (찬송가 460장)',
    },
